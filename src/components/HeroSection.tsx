    ...
    <section className="pt-24 pb-12 px-4 bg-white">
      <div className="container mx-auto">
        <div className={`max-w-3xl mx-auto text-center transform ${isVisible ? 'animate-fadeIn' : 'opacity-0'}`}>
          ...
          <h1 className="mb-6 text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900">
            Sua conexão com a
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <button className="px-8 py-3 text-lg font-medium text-gray-600 border border-gray-300 hover:border-primary rounded-lg transition-colors">
              Saiba Mais
            </button>
          </div>
        </div>
